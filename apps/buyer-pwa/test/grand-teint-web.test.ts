...
/**
 * WO-5.1 — the Grand Teint web substrate (buyer-pwa): the 30 inline icons,
...
describe('the 30 inline PWA icons carry the design-reference geometry', () => {
  // PROFIL-REVENDEUR-1 (2026-08-25): profil.svg joined the canon — 30.
  it('exactly 30 entries, matching the canonical glyph names', () => {
