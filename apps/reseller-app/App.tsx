...
const styles = StyleSheet.create({
  ...
  // what comes after. Every number below is a token ON the scale (the
  // verifier's MAJOR, handled once: no `token + 2` offsets).
  entreeContenu: { paddingHorizontal: spacing.lg, paddingTop: spacing.xxl - spacing.xs, paddingBottom: spacing.xxl, gap: spacing.lg },
  entreeEntete: { gap: spacing.sm },
  ...
  railEtape: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, flexShrink: 1 },
  railBulle: { width: spacing.xl, height: spacing.xl, borderRadius: radius.pill, alignItems: 'center', justifyContent: 'center', borderWidth: interaction.hairline.strong, borderColor: sharedColour.hairlineStrong },
  ...
  railBulleTexte: { color: sharedColour.sub, fontFamily: TEXT_FAMILY_BOLD, fontSize: t2.scale.pill.size, fontWeight: w(t2.scale.pill.wght) },
  railBulleTexteOn: { color: shopColour.onPrimary },
  railLabel: { flexShrink: 1, color: sharedColour.sub, fontFamily: TEXT_FAMILY_BOLD, fontSize: rmax(t2.scale.caps.size), fontWeight: w(t2.scale.caps.wght), letterSpacing: rmax(t2.scale.caps.size) * CAPS_TRACK, textTransform: 'uppercase' },
  ...
  entreeCarte: { backgroundColor: sharedColour.card, borderWidth: interaction.hairline.thin, borderColor: sharedColour.hairline, borderRadius: radius.card, paddingHorizontal: spacing.lg, paddingVertical: spacing.lg, gap: spacing.lg },
  carteTrait: { height: interaction.hairline.thin, backgroundColor: sharedColour.hairline },
  champ: { gap: spacing.sm },
  ...
  champInput: { minHeight: touch.minTargetPx, borderWidth: interaction.hairline.medium, borderColor: sharedColour.hairlineInput, borderRadius: rmax(radius.buttonSecondary), paddingHorizontal: spacing.md, color: sharedColour.ink, fontFamily: TEXT_FAMILY, fontSize: rmax(t2.scale.body.size), backgroundColor: sharedColour.paper },
  ...
  chipRangee: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  lienRangee: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.sm, minHeight: touch.minTargetPx },
  ...
  confianceRangee: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.sm },
