...
// §6.1’s non-refundable-delivery WARNING has been deleted from the PAIEMENT table.
// Nothing is misspelled and nothing lints red — the sentence simply is not there
// any more. A deleted string must fail as loudly as a violated one.
