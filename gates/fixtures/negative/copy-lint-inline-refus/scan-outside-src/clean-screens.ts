// NEGATIVE FIXTURE (source half) for the copy-lint-inline-refus gate — SP3.3b1
// round 2. Every table here is CLEAN and lints green on purpose: the plant lives
// in the sibling index.html, so the ONLY thing that can fail this fixture is the
// raw §6.1 word scan reaching a file that is not a .ts under src/.
