...
// Every string is clean French Voice — the forbidden word appears ONLY in a class
// name and a data attribute, i.e. exactly where a string-extracting lint cannot
// look and where the DOM ships it anyway. Only the raw §6.1 scan catches this.
...
export function renderPayOption(): string {
