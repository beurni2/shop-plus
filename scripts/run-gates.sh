...
capture drift-check-positive pass pnpm exec drift-check docs --pinned-version 2.3.0
...
capture drift-check-negative fail pnpm exec drift-check "$DRIFT_TMP/docs" --pinned-version 2.3.0
rm -rf "$DRIFT_TMP"
