...
capture drift-check-positive pass pnpm exec drift-check docs --pinned-version 1.0.1
...
capture drift-check-negative fail pnpm exec drift-check "$DRIFT_TMP/docs" --pinned-version 1.0.1
rm -rf "$DRIFT_TMP"
